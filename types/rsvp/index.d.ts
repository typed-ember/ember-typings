...
declare module 'rsvp' {
    class RSVPPromise<T> extends Promise<T> {
        readonly prototype: RSVPPromise<any>;
        new<T>(
            executor: (
        ...
        all<T>(values: (T | PromiseLike<T>)[]): RSVPPromise<T[]>;
        ...
        race<T>(values: (T | PromiseLike<T>)[]): RSVPPromise<T>;
